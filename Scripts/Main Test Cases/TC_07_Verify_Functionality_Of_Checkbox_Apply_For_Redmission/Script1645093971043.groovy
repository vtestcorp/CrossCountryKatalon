...
WebUI.comment('User navigate to appoinment page')
...
WebUI.getText(findTestObject('Page_AppointmentConfirmation/Page_CURA Healthcare Service/Page_CURA Healthcare Service/label_Apply for hospital readmission'))

WebUI.verifyElementPresent(findTestObject('Page_CuraAppointment/chk_Readmission'), 0)

WebUI.verifyElementClickable(findTestObject('Page_AppointmentConfirmation/Page_CURA Healthcare Service/Page_CURA Healthcare Service/input_'))
